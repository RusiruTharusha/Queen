...
async function connectToWA() {
  ...
  console.log("Connecting ❤️test❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️test❤️ installed successful ✅");
      console.log("❤️test❤️ connected to whatsapp ✅");

      let up = `❤️ connected successful ✅`;
      let up1 = `Hello Rusiru, I made bot successful`;
      ...
      robin.sendMessage("94714774537@s.whatsapp.net", {
        image: {
          url: `https://github.com/RusiruTharusha/Queen/blob/main/d0a654b5d62322aa430af70231660f91.jpg`,
        },
        caption: up1,
